...
| Case 2: HTTP/10 threads                        | ![](https://github.com/kjstrong/CS122B-Fabflix/blob/main/img/case_2_single_screenshot.png)   | 93                         | 50                                  | 50                        | Due to the extra load of 10 threads, the query time was predictably higher than that of the single thread test.           |
