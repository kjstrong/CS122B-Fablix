...
|------------------------------------------------|------------------------------|----------------------------|-------------------------------------|---------------------------|--------------|
| Case 1: HTTP/1 thread                          | ![](https://github.com/kjstrong/CS122B-Fabflix/tree/main/img/case_1_single_screenshot.png)   | 54                         | 13                                  | 13                        | The single thread had a standard query time which was used to measure the baseline of the other tests.           |
